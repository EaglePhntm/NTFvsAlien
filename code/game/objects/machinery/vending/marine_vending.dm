/obj/machinery/vending/weapon
	...
	products = list(
		"Rifles" = list(
			...
			/obj/item/ammo_magazine/rifle/nt_halter/extended = 1,
			/obj/item/ammo_magazine/rifle/nt_halter/laser/extended = 1,
			/obj/item/ammo_magazine/rifle/nt_halter/drum = 1,
			/obj/item/ammo_magazine/rifle/nt_halter/laser/drum = 1,
			/obj/item/ammo_magazine/rifle/nt_halter/charged = 1,
			/obj/item/ammo_magazine/rifle/nt_halter/smart = 2,
			/obj/item/ammo_magazine/rifle/nt_halter/foxfire = 1,
		),
		"Energy Weapons" = list(
...
/obj/machinery/vending/weapon/crash
	products = list(
		"Rifles" = list(
			...
			/obj/item/ammo_magazine/rifle/nt_halter = -1,
			/obj/item/ammo_magazine/rifle/nt_halter/laser = -1,
			/obj/item/ammo_magazine/rifle/nt_halter/extended = 4,
			/obj/item/ammo_magazine/rifle/nt_halter/laser/extended = 4,
			/obj/item/ammo_magazine/rifle/nt_halter/drum = 4,
			/obj/item/ammo_magazine/rifle/nt_halter/laser/drum = 4,
			/obj/item/ammo_magazine/rifle/nt_halter/charged = 2,
			/obj/item/ammo_magazine/rifle/nt_halter/smart = 4,
			/obj/item/ammo_magazine/rifle/nt_halter/foxfire = 4,
		),
		"Energy Weapons" = list(
			/obj/item/cell/lasgun/lasrifle = -1,
			/obj/item/cell/lasgun/volkite/powerpack/marine = -1,
