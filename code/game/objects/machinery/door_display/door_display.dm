...
/obj/machinery/door_display/interact(mob/user)
	...
	if(open)
		data += "<a href='byond://?src=[text_ref(src)];open=0'>Close Door</a><br/>"
	else
		data += "<a href='byond://?src=[text_ref(src)];open=1'>Open Door</a><br/>"
...
/obj/machinery/door_display/research_cell/interact(mob/user)
	...
	if(open_shutter)
		data += "<a href='byond://?src=[text_ref(src)];shutter=0'>Close Shutter</a><br/>"
	else
		data += "<a href='byond://?src=[text_ref(src)];shutter=1'>Open Shutter</a><br/>"
