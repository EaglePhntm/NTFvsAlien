...
DEFINE_BITFIELD(round_type_flags, list(
	...
	"MODE_NO_GHOSTS_STRICT" = MODE_NO_GHOSTS_STRICT,
	"MODE_SINGLE_USE_NUKE_DISK_GENERATOR" = MODE_SINGLE_USE_NUKE_DISK_GENERATOR,
	"MODE_CHILL_RULES" = MODE_CHILL_RULES,
))
DEFINE_BITFIELD(round_type_flags2, list(
	"MODE_CAMPAIGN_LITE_SUPPORT" = MODE_CAMPAIGN_LITE_SUPPORT,
	"MODE_NO_GHOSTS" = MODE_NO_GHOSTS,
	"MODE_NO_ABDUCE" = MODE_NO_ABDUCT,
	))
