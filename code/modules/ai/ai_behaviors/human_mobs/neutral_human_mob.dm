/datum/ai_behavior/human/ai/neutral
	sidestep_prob = 25
	...
	var/list/new_move_chat = list("I'm going.", "I need to go.", "Let me move.", "I need to move.", "I'm gonna go.", "Personal space!", "Let's get outta' here.", "I need to get going!", "Go go go!!", "Gonna go.", "I'm leaving.", "I'm legging it.")
	///Chat lines when following a new target
	var/list/new_follow_chat = list("Following.", "Following you.", "I'm right behind you!", "Take the lead.", "Let's move!", "Let's go!", "Stay together!", "In formation.", "Where to?",)
	///Chat lines when engaging a new target
	var/list/new_target_chat = list("Get out of here!!", "Holy shit!", "Oh fuck!", "It's getting dangerous!", "What the-", "Help!", "I'm not sticking around!", "*gasp", "Aw shit.", "What is this?", "What's going on?!", "Shit!!", "Get away!!", "Run!!")
	///Chat lines for retreating on low health
	var/list/retreating_chat = list("I'm fucking hurt!", "Augh shit!, I'm hit!", "I'm hit!", "I don't want to die!", "Fuck this, man!", "Help me!", "Need help here!", "I'm getting the fuck outta' here!", "Oh no.", "I'm getting hit!", "I'm getting shot at!", "Run for it!")
