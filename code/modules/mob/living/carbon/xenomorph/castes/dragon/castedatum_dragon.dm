/datum/xeno_caste/dragon
	...
	// *** Melee Attacks *** //
	melee_damage = 30
	exosuit_slash_damage_multiplier = 4
...
*/
	caste_flags = CASTE_FIRE_IMMUNE|CASTE_IS_INTELLIGENT|CASTE_INSTANT_EVOLUTION|CASTE_LEADER_TYPE|CASTE_EVOLUTION_ALLOWED|CASTE_MUTATIONS_ALLOWED
