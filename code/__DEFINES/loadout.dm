...
GLOBAL_LIST_INIT(specialist_gear_listed_products, list(
	...
	/obj/item/storage/box/crate/loot/infiltration_pack_spec = list(CAT_SPSUP, "Infiltrator Pack (Nonlethal gear + NVG + scout cloak)", 40, "black"),
	/obj/item/storage/box/crate/loot/infiltration_lethal_pack_spec = list(CAT_SPSUP, "Assassin Pack (Lethal gear + NVG + scout cloak)", 40, "black"),
	/obj/item/storage/box/crate/loot/infiltration_tback_pack_spec = list(CAT_SPSUP, "Infiltrator Pack (Leotard variant)", 40, "black"),
	/obj/item/storage/box/crate/loot/infiltration_lethal_tback_pack_spec = list(CAT_SPSUP, "Assassin Pack (Leotard variant)", 40, "black"),
	...
	/obj/item/ammo_magazine/smg/m25/ap = list(CAT_SPSUP, "SMG-25 Armor penetrating magazine", 2, "black"),
...
GLOBAL_LIST_INIT(vanguard_gear_listed_products, list(
	...
	/obj/item/storage/backpack/marine/satchel/scout_cloak = list(CAT_CDSUP, "Scout Cloak", 15, "black"),
	/obj/item/clothing/glasses/thermal/m64_thermal_goggles = list(CAT_CDSUP, "M64 Thermal Goggles", 15, "black"),
	/obj/item/clothing/glasses/night/m42_night_goggles = list(CAT_CDSUP, "M42 Night Vision Goggles", 10, "orange"),
	/obj/item/storage/box/crate/loot/operator_pack = list(CAT_CDSUP, "Operator Pack (PR-412E + AP & Incen Mags)", 30, "orange"),
	/obj/item/storage/box/crate/loot/m25e_pack = list(CAT_CDSUP, "CQC Pack (SMG-25BE + AP-Mags)", 25, "orange"),
	/obj/item/storage/box/crate/loot/scoutrifle_pack_spec = list(CAT_CDSUP, "Scout Rifle Pack (BR-8 + Mixed Mags + Packet + NVG)", 15, "orange"),
	/obj/item/storage/box/crate/loot/infiltration_pack_spec = list(CAT_SPSUP, "Infiltrator Pack (Nonlethal gear + NVG + scout cloak)", 35, "black"),
	/obj/item/storage/box/crate/loot/infiltration_lethal_pack_spec = list(CAT_SPSUP, "Assassin Pack (Lethal gear + NVG + scout cloak)", 35, "black"),
	/obj/item/storage/box/crate/loot/infiltration_tback_pack_spec = list(CAT_SPSUP, "Infiltrator Pack (Leotard variant)", 35, "black"),
	/obj/item/storage/box/crate/loot/infiltration_lethal_tback_pack_spec = list(CAT_SPSUP, "Assassin Pack (Leotard variant)", 35, "black"),
	/obj/item/storage/box/crate/loot/smartpistol_spec = list(CAT_CDSUP, "Smartpistol Pack (Smartpistol + mags)", 5, "orange"),
	/obj/item/ammo_magazine/rifle/ap = list(CAT_CDSUP, "PR-412 Armor Piercing Magazine", 2, "black"),
	/obj/item/ammo_magazine/rifle/incendiary = list(CAT_CDSUP, "PR-412 Incendiary Magazine", 2, "black"),
	/obj/item/ammo_magazine/rifle/tx8 = list(CAT_CDSUP, "BR-8 High Velocity Magazine", 1, "black"),
	...
	/obj/item/ammo_magazine/smg/m25/ap = list(CAT_CDSUP, "SMG-25 Armor penetrating magazine", 2, "black"),
