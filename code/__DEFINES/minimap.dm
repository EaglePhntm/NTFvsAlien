...
#define MINIMAP_FLAG_MARINE_CLF (1<<5)
#define MINIMAP_FLAG_SURVIVOR (1<<6)
#define MINIMAP_FLAG_KZ (1<<7)
#define MINIMAP_FLAG_ICC (1<<8)
#define MINIMAP_FLAG_ZOMBIE (1<<9)
#define MINIMAP_FLAG_ALPHA_HIVE (1<<10)
#define MINIMAP_FLAG_BETA_HIVE (1<<11)
#define MINIMAP_FLAG_ZETA_HIVE (1<<12)
#define MINIMAP_FLAG_ADMEME_HIVE (1<<13)
#define MINIMAP_FLAG_ALL (1<<14) - 1
...
GLOBAL_LIST_INIT(faction_to_minimap_flag, list(
	...
	FACTION_CLF = MINIMAP_FLAG_MARINE_CLF,
	FACTION_VSD = MINIMAP_FLAG_KZ,
	FACTION_ICC = MINIMAP_FLAG_ICC,
...
//General areas
#define MINIMAP_AREA_NTF_OUTSIDE "#d4d4d4"
#define MINIMAP_AREA_NTF_INSIDE "#1f1f1f"

//Big Red V3
#define MINIMAP_AREA_NTF_CARGO "#9C4D00"
#define MINIMAP_AREA_NTF_COLONY "#009800"
#define MINIMAP_AREA_NTF_COMMAND "#000066"
#define MINIMAP_AREA_NTF_DIRECT "#f7f095"
#define MINIMAP_AREA_NTF_ENGI "#D55500"
#define MINIMAP_AREA_NTF_LAMBDA "#9933FF"
#define MINIMAP_AREA_NTF_MAINT "#616161"
#define MINIMAP_AREA_NTF_MEDICAL "#33CCFF"
#define MINIMAP_AREA_NTF_RESEARCH "#FF66FF"
#define MINIMAP_AREA_NTF_SECURITY "#750000"
