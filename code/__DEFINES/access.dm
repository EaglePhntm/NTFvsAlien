...
#define ALL_ICC_ACCESS list(ACCESS_MARINE_MEDBAY, ACCESS_MARINE_CHEMISTRY, ACCESS_CIVILIAN_PUBLIC, ACCESS_CIVILIAN_RESEARCH, ACCESS_CIVILIAN_ENGINEERING, ACCESS_CIVILIAN_LOGISTICS, ACCESS_ICC_PREP, ACCESS_ICC_MEDPREP, ACCESS_ICC_GUARDPREP, ACCESS_ICC_LEADPREP, ACCESS_ICC_CARGO, ACCESS_ICC_TADPOLE, ACCESS_ICC_SECURITY)
