...
GLOBAL_LIST_INIT(jobs_som, list(SOM_SQUAD_MARINE, SOM_SQUAD_VETERAN, SOM_SQUAD_ENGINEER, SOM_SQUAD_CORPSMAN, SOM_SQUAD_LEADER, SOM_FIELD_COMMANDER, SOM_STAFF_OFFICER, SOM_COMMANDER, SOM_SQUAD_SLUT, SOM_PILOT_OFFICER, SOM_MECH_PILOT, SOM_REQUISITIONS_OFFICER, SOM_CHIEF_MEDICAL_OFFICER, SOM_TECH, SOM_MEDICAL_DOCTOR, SOM_CHEF, SOM_ASSAULT_CREWMAN))
...
SOM_SQUAD_SLUT, SOM_SQUAD_MARINE, SOM_SQUAD_VETERAN, SOM_SQUAD_ENGINEER, SOM_SQUAD_CORPSMAN, SOM_SQUAD_LEADER, SOM_CHEF, SOM_MEDICAL_DOCTOR, SOM_TECH, SOM_CHIEF_MEDICAL_OFFICER, SOM_CHIEF_ENGINEER, SOM_REQUISITIONS_OFFICER, SOM_MECH_PILOT, SOM_PILOT_OFFICER, SOM_FIELD_COMMANDER, SOM_STAFF_OFFICER, SOM_COMMANDER, SOM_ASSAULT_CREWMAN, \
