...
/obj/item/mecha_parts/mecha_equipment/ability/night_vision/exosuit
	...
	desc = "A night vision optical suite designed to be mounted on exosuits. Consumes a lot of energy when active.."
	icon_state = "nvgs"
	equipment_slot = MECHA_UTILITY
	mech_flags = EXOSUIT_MODULE_NTF|EXOSUIT_MODULE_COMBAT
...
/obj/item/mecha_parts/mecha_equipment/passenger_compartment
	...
	desc = "A compartment that's able to be fitted to the interior of an exosuit, somehow increasing the passenger capacity."
	icon_state = "compartment"
	equipment_slot = MECHA_UTILITY
	var/increase_occupant_count_by = 2
