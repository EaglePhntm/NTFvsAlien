/obj/vehicle/sealed/mecha/ntf/phazon
	...
	soft_armor = list(MELEE = 40, BULLET = 40, LASER = 50, ENERGY = 30, BOMB = 25, BIO = 0, FIRE = 80, ACID = 100)
	force = 20
...
/obj/vehicle/sealed/mecha/ntf/phazon/generate_actions()
	. = ..()
	initialize_passenger_action_type(/datum/action/vehicle/sealed/mecha/pulsearmor)
