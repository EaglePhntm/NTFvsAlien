/datum/game_mode/infestation/survival
	name = "Survival"
	config_tag = "Survival"
	round_type_flags = MODE_INFESTATION|MODE_DISALLOW_RAILGUN|MODE_PSY_POINTS|MODE_XENO_SPAWN_PROTECT|MODE_SURVIVAL|MODE_XENO_GRAB_DEAD_ALLOWED|MODE_MUTATIONS_OBTAINABLE|MODE_NO_GHOSTS_STRICT
	round_type_flags2 = MODE_2_NO_GHOSTS
