...
/datum/chemical_reaction/milkresearch
	results = null
	required_reagents = list(/datum/reagent/consumable/milk/human = 15)
...
/datum/chemical_reaction/girlresearch
	results = null
	required_reagents = list(/datum/reagent/consumable/nutriment/cum/girl = 15)
	required_catalysts = list(/datum/reagent/medicine/lemoline = 5)
...
/datum/chemical_reaction/boyresearch
	results = null
	required_reagents = list(/datum/reagent/consumable/nutriment/cum = 15)
	required_catalysts = list(/datum/reagent/medicine/lemoline = 5)
