/obj/item/clothing/under/marine/sneaking
	...
	desc = "An extremely expensive sneaking suit created by an Ninetails Corporation for high risk stealth missions, made with several layers of a nano-fiber that, while light, molds to the wearer's body shape and hardens protecting them. Only provided rarely to most successful Senior Operatives or higher. This uniform allows you to walk quietly ALT-CLICK. To change the variant of the suit, ALT-RIGHTCLICK on it."
...
/obj/item/clothing/under/marine/sneaking/AltRightClick(mob/user)
	...
	switch(variant)
		if(1)
			name = "NTF Infiltration Uniform"
			desc = "An extremely expensive sneaking suit created by an Ninetails Corporation for high risk stealth missions, made with several layers of a nano-fiber that, while light, molds to the wearer's body shape and hardens protecting them. Only provided rarely to most successful Senior Operatives or higher. This uniform allows you to walk quietly with ALT-CLICK. To change the variant of the suit, ALT-CLICK on it."
			icon_state = "sneak"
		if(2)
			name = "NTC Spec-Ops Tactical T-Back Leotard"
			desc = "An extremely expensive sneaking leotard with extra skin-showing properties created by an Ninetails Corporation for high risk missions with high risk clothes, made with several layers of a nano-fiber that, while light, molds to the wearer's body shape and hardens protecting them. Only provided rarely to most successful Senior Operatives or higher. This leotard allows you to walk quietly with ALT-CLICK"
